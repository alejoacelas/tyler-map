...
export async function GET(request: NextRequest) {
  ...
  if (!/^(country:[a-z0-9]+|geonames:[a-z0-9]+|admin1:[a-z0-9]+\.[a-z0-9]+)$/i.test(placeId)) return NextResponse.json({ error: "Use a canonical place_id such as country:tr, admin1:us.ut, or geonames:745044." }, { status: 400 });
